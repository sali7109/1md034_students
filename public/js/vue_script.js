...
let burger4 = new menuItem("A new burger", 440, false, true, "./img/burger3.jpg", "box c")
let burger5 = new menuItem("Another new burger", 440, true, false, "./img/burger3.jpg", "box c")
